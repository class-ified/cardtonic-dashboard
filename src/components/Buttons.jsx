...
export const GetMoreButton = () => {
	...
	return (
		<Link to="/transactions" className="get-more-link">
			...
			>
				<h3 className="text-xs text-regular">Get More</h3>
...
export const BlackSubmit = ({ text, onClick, className }) => {
	return (
		<button type="submit" className={`black-submit ${className}`} onClick={onClick}>
...
export const BigBlackSubmit = ({ className, text, onClick, loading, ...props }) => {
	return (
		<button
			type="submit"
			className={`black-submit ${className}`}
			style={{ width: "218px" }}
			disabled={loading}
			onClick={onClick}
			{...props}
