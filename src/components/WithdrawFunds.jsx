...
const WithdrawFunds = ({handlePopupView, openPopup}) => {
    ...
    return (
        <>
            {openPopup && <Popup className="withdraw-funds-popup">
                ...
                <h3 className="error-heading text-error text-small text-bold">This is a dummy text for the Admin - Access Bank not working currently, please try other Banks</h3>

                <form action="#">
                    <input className="default-input" type="number" name="amount" placeholder="Enter Amount to Withdraw" />
                    <span className="horizontal-line"></span>

                    <div className="account-list-box">
                        <h3 className="heading text-small text-success text-vbold">Select Bank</h3>
                        
                        <input type="radio" id="account-1" name="account" />
                        <label htmlFor="account-1">
                            <div className="account-details">
                                <h3 className="text-regular text-small text-blue">Bank - <span className="text-vbold">Access Bank</span></h3>
                                <h3 className="text-regular text-small text-blue">Account Number - <span className="text-vbold">0177386427</span></h3>
                                <h3 className="text-regular text-small text-blue">Account Name - <span className="text-vbold">Julia Morgan Agbaje</span></h3>
