...
const CompleteTrade = ({ handlePopup, popupOpen, submitOnClick }) => {
	const closePopup = () => {
		handlePopup(false);
	};
			...
			{popupOpen && (
				<Popup className="complete-trade">
					...
					<h3 className="text-error text-small text-bold">
						We are not liable for any error from you, please keep
						your card safe, and make sure no one is watching while
						you upload your card.
					</h3>

					<button
						type="submit"
						className="complete-trade-button"
						onClick={submitOnClick}
					>
						<h3 className="text-white text-bold text-small">
							Complete Trade
						</h3>
