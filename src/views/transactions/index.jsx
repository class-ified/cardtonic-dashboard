        ...
        <main className="transactions">
            <div className="transactions__top">
                <div className="heading-box">
                    <h3 className="text-kindabig text-blue text-vbold">Gift Card</h3>
                    <h3 className="text-18 text-vbold" style={{color: "#BFBFBF"}}>History</h3>
                </div>
                ...
                <div className="cards-box">
                    <div className="card">
                        <div className="left">
                            ...
                            <h3 className="text-xs text-regular" style={{color: '#BFBFBF'}}>Successful</h3>
                        </div>

                        <div className="right">
                            <h1 className="text-blue text-vbold text-kindabigger">106</h1>
                        </div>
                    </div>
                    ...
                    <div className="card">
                        <div className="left">
                            ...
                            <h3 className="text-xs text-regular" style={{color: '#BFBFBF'}}>Failed</h3>
                        </div>
                    ...
                    <div className="card">
                        <div className="left">
                            ...
                            <h3 className="text-xs text-regular" style={{color: '#BFBFBF'}}>Pending</h3>
                        </div>
