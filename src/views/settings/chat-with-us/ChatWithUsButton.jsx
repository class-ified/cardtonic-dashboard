import ChatWithUsPopup from "./ChatWithUsPopup";
...
const ChatWithUsButton = () => {
    ...
    return (
        <>
            <ChatWithUsPopup handlePopup={handlePopup} popupOpen={popupOpen} />
            <div style={{cursor: "pointer"}} className="settings__body-option" onClick={() => handlePopup(true)}>
                <h3 className="text-blue text-vbold text-small">Chat with Us</h3>
